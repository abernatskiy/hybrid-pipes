...
import {
  type AddLiquidity,
  BaseHandler,
  type InitializeLiquidity,
  type RemoveLiquidity,
  type SwapLiquidityEvent,
} from './base-handler'
...
export class RaydiumAmmHandler extends BaseHandler {
  ...
  handleRemoveLiquidity(instruction: Instruction, block: Block): RemoveLiquidity {
  ...
  handleInitializePool(instruction: Instruction, block: Block): InitializeLiquidity {
  ...
  private handleSwap(instruction: Instruction, block: Block): SwapLiquidityEvent {
